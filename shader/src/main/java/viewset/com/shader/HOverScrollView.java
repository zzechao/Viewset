...
public class HOverScrollView extends LinearLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                Log.e("TEST", "onInterceptTouchEvent ACTION_DOWN");
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                Log.e("TEST", "onInterceptTouchEvent ACTION_POINTER_DOWN");
            ...
            case MotionEvent.ACTION_MOVE:
                Log.e("TEST", "onInterceptTouchEvent ACTION_MOVE");
            ...
            case MotionEvent.ACTION_POINTER_UP:
                Log.e("TEST", "onInterceptTouchEvent ACTION_POINTER_UP");
                index = MotionEventCompat.getActionIndex(ev);
            ...
            case MotionEvent.ACTION_UP:
                Log.e("TEST", "onInterceptTouchEvent ACTION_UP");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                Log.e("TEST", "onTouchEvent ACTION_DOWN");
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    //直接滑动
                    Log.e("TEST1", "overscroll" + deltaY + " scrollRange" + getScrollRange() + " overScrollDistance" + mOverScrollDistance);
                    ...
                    mLastY = y;
                    if (pulledToY < 0) {
                        Log.e("TEST1", "pulledTOY top" + getHeight() + "deltaY" + deltaY);
                ...
                break;
            case MotionEvent.ACTION_CANCEL:
                Log.e("TEST", "onTouchEvent ACTION_CANCEL");
                endDrag();
                break;
            case MotionEvent.ACTION_UP:
                ...
                if (mIsBeingDragged) {
                    ...
                    Log.e("TEST", "velocity=" + initialVelocity + " " + mMinFlingSpeed + " scrollY=" + getScrollY());
                    if (getScrollY() < 0 || getScrollY() > getScrollRange()) {
                        ...
                        int dy = getScrollY() < 0 ? 0 : getScrollRange();
                        animator = ValueAnimator.ofInt(getScrollY(), dy);
    ...
    private void doFling(int speed) {
        ...
        mScroller.fling(0, getScrollY(), 0, speed, 0, 0, -500, 20000);
        invalidate();
    }
    ...
    protected void onOverScrolled(int scrollX, int scrollY, boolean clampedX, boolean clampedY) {
        Log.e("TEST", "onOverScrolled x" + scrollX + " y" + scrollY + " finish =" + mScroller.isFinished());
